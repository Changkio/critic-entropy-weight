...
本项目用于学习指标正向化、熵权法、CRITIC 法及综合评分。初稿由 AI 生成，随后经 AI 辅助审查、边界修复和自动化测试整理。代码为独立教学实现，不包含真实挑战杯、其他获奖项目或商业项目的原始源码。
...
依赖为 NumPy 与 pandas；本次验证环境为 Python 3.12、NumPy 2.3、pandas 3.0。
